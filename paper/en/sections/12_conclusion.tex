...
\begin{enumerate}
    \item \textbf{Intrinsic epistemology}: For the first time, an LLM
    produces complete epistemic tomography (30+ fields) per token,
    trained end-to-end with the language model.
...
The 354M parameter model can be trained on a single RTX 4090 (24GB VRAM)
in approximately 8--10 days with 7B tokens from FineWeb-Edu.
