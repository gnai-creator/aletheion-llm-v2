% ============================================================
% Secao 4: Manifold Riemanniano Diferenciavel (DRM)
% ============================================================

\section{Manifold Riemanniano Diferenci\'avel (DRM)}
\label{sec:drm}

O \textit{Differentiable Riemannian Manifold} (DRM) \'e o substrato
...
com $\bm{W}_1 \in \R^{32 \times d}$, $\bm{W}_2 \in \R^{16 \times 32}$,
$\bm{W}_3 \in \R^{5 \times 16}$, totalizando ~50K par\^ametros.
