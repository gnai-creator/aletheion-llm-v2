...
\begin{enumerate}
    \item \textbf{Epistemologia intr\'inseca}: At\'e onde sabemos, o
    \aletheion{} \'e o primeiro LLM a produzir tomografia epist\^emica
    completa (30+ campos) por token, treinada \textit{end-to-end} com o
    modelo de linguagem. Trabalhos anteriores exploraram estima\c{c}\~ao
    de incerteza intr\'inseca \cite{gal2016dropout, lakshminarayanan2017simple},
    mas limitam-se a estimativas escalares de confian\c{c}a ou vari\^ancia,
    sem produzir estado epist\^emico estruturado e multidimensional por token.
...
O backbone de 354M par\^ametros \'e treinado em 4$\times$ H100 em
~13 horas com 7B tokens do FineWeb-Edu, seguido de fine-tuning
epist\^emico em uma \'unica RTX 4090 (24GB VRAM).
